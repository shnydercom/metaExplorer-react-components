...
exports.MiniToolBox = (props) => {
    ...
    const renderContent = () => {
        return (React.createElement("div", { onMouseOver: isMini ? (e) => setIsMiniOpen(true) : (e) => { }, onMouseOut: isMini ? (e) => {
			...
			` },
                React.createElement(watch_1.Watch, { btnProps: watchBtnProps, watchClass: `${exports.CSS_CLASSNAME}-${isMini ? 'mini' : 'max'}` })),
            React.createElement("div", { onClick: isMini ? (e) => {
			...
			` },
                React.createElement(phone_1.Phone, { btnProps: phoneBtnProps, phoneClass: `${exports.CSS_CLASSNAME}-${isMini ? 'mini' : 'max'} ` })),
            true ? React.createElement("div", { style: {} /*hiddenIntangibleChildren*/ }, props.children) : null));
    };
