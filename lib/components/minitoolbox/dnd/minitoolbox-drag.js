...
const draglayer_w_children_1 = require("./draglayer-w-children");
...
exports.MiniToolBox = (props) => {
    ...
    return (React.createElement("div", { className: `${exports.CSS_CLASSNAME}-root`, style: { left: props.left, top: props.top } },
        React.createElement(draglayer_w_children_1.default, { acceptedItemTypes: [ItemTypes_1.ItemTypes.Block, ItemTypes_1.ItemTypes.MiniToolBox] }, renderContent(true)),
