...
exports.MiniToolBox = (props) => {
    ...
    const [{ isDragging }, drag, preview] = react_dnd_1.useDrag({
        item: { id: props.id, left: props.left, top: props.top, type: ItemTypes_1.default.MiniToolBox },
        collect: monitor => ({
    ...
    const renderContent = (isDragLayer) => {
        return (React.createElement("div", { onMouseOver: isMini ? (e) => setIsMiniOpen(true) : (e) => { }, onMouseOut: isMini ? (e) => setIsMiniOpen(false) : (e) => { }, className: `${exports.CSS_CLASSNAME}-enclosing ${className ? className : ''}` },
            ...
            isDragLayer
                ? React.createElement(mini_button_1.MiniButton, { className: "minitoolbox-dndhandle", iconSrc: "/static/move.svg", onClick: () => { } })
                : React.createElement(mini_button_1.MiniButton, { className: "minitoolbox-dndhandle", iconSrc: "/static/move.svg", btnRef: drag, onClick: () => { } })));
    };
